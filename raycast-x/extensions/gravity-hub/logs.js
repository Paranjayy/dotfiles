...
function Command() {
  ...
  const L = import_api.List;
  const LI = import_api.List.Item;
  const AP = import_api.ActionPanel;
  const A2 = import_api.Action;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(L, { isLoading, searchBarPlaceholder: "Search house chronicle...", children: logs.map((log, i2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    LI,
    {
      icon: import_api.Icon.Calendar,
      title: log,
      actions: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AP, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(A2, { title: "Refresh Logs", onAction: refresh }) })
    },
    i2
  )) });
}
